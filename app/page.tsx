      ...
      <div className="space-y-4">
        ...
        <div className="bg-[#1A1A4B] rounded-2xl p-4 border border-gray-700">
          ...
          <div className="flex gap-2">
            <button onClick={handleStreamClick} className="flex-1 py-2 bg-yellow-500 text-black rounded-lg text-xs font-bold">Stream 2 (Beinmatch) ↗</button>
            <button onClick={handleStreamClick} className="flex-1 py-2 bg-blue-600 rounded-lg text-xs font-bold">Stream 3 (Alternative) ↗</button>
          </div>
        </div>
