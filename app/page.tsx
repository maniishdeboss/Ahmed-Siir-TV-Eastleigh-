...
const WATCH_BY_COUNTRY = [
  ...
  { country: "Kenya 🇰🇪 ", status: "Live Streaming", bg: "from-red-500 to-green-600" },
  { country: "Ogadenia 🇬🇲 ", status: "Available", bg: "from-green-700 to-white/100" },
];

const HIGHLIGHTS = [
  { title: "Goals Highlights⚽🏆 🔥", duration: "10 min", desc: "All weekend goals" },
  { title: "Flim Hindi afsomali 📺", duration: "24/7 min", desc: "Full tactical breakdown" },
  { title: "News Somalia 📺🇸🇴🇬🇲 ", duration: "5 min", desc: "Best goalkeeping" },
  ...
  return (
    <div className="bg-[#06060f] min-h-screen text-white pb-28 font-sans antialiased selection:bg-blue-500">
      ...
      <div className="p-4 bg-gradient-to-b from-blue-950/40 to-[#06060f] border-b border-white/5">
        <h1 className="text-xl font-black tracking-wider text-center bg-gradient-to-r from-blue-400 via-white to-green-400 bg-clip-text text-transparent mb-4">
