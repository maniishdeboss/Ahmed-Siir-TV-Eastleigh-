...
const MOCK_MATCHES: { [key: string]: Match[] } = {
  'fifa-world-cup-2026': [{
    ...
    link_1: 'https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel.ism/.m3u8',
    link_2: 'https://cph-p2p-msl.akamaized.net/hls/live/2000341/test/master.m3u8'
  }],
  'epl': [{
